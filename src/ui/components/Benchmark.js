      ...
      <React.Fragment>
          ...
          description={
            <React.Fragment>
              <p>
                ...
                using the{" "}
                <a
                  href="https://pspdfkit.com/api/web/PSPDFKit.Instance.html#renderPageAsArrayBuffer"
                  target="_blank"
        ...
        <Test
          ...
          description={
            <p>
              ...
              <a
                href="https://pspdfkit.com/api/web/PSPDFKit.Instance.html#search"
                target="_blank"
                rel="noopener noreferrer"
              >
                search API
          ...
          description={
            <React.Fragment>
              ...
              <p>
                ...
                fields called{" "}
                <a
                  href="https://pspdfkit.com/guides/web/current/importing-exporting/instant-json/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  InstantJSON
              ...
              <p>
                ...
                <a
                  href="https://pspdfkit.com/guides/web/current/importing-exporting/xfdf-support/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  XFDF support
        ...
        <Test
          ...
          description={
            <p>
              In this benchmark, we use our{" "}
              <a
                href="https://pspdfkit.com/guides/web/current/annotations/introduction-to-annotations"
                target="_blank"
                rel="noopener noreferrer"
              >
                annotations API
            ...
            isWasm ? (
              <React.Fragment>
                <p>
                  ...
                  downloading, compiling, and instantiation. In this benchmark,
                  we ignore download time.
                </p>
                <p>
                  Read about how you can{" "}
                  <a
                    href="https://pspdfkit.com/blog/2018/optimize-webassembly-startup-performance"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <p>
                  This test must run at the end to avoid penalizing browsers
                  that run a baseline compiler first. In those cases, multiple
                  initializations might start a background compilation which
        ...
        {state === "done" && (
          <div className="ResultCTA">
            <a href="https://pspdfkit.com/web/" className="Button">
