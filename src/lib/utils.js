...
// result.
const ignoredResourceRegex = /.*nutrient.w?asm.*/;
...
// Parses the url to retrieve the configuration options for Nutrient Web.
...
// The same Wasm test that is used in Nutrient Web
...
// We don't want to show the final Nutrient Web view if we're on a mobile
